...
{
?>
<a href="../doc/papers/<? echo $IDpaper; ?>.pdf" target="_blank">файл внесено <img src="img/pdf_button.png"  width="15" height="15" /></a> 
<br>
але можете завантажити новий файл і замінити цей
<?
   
} else echo "файл (стаття)";
?>
...
<span style="font-size:10px; background-color:#FFFF66">Ваш IP:&nbsp;<? $R=getenv("REMOTE_ADDR"); $userIP=explode(".", $R); echo $R;?></span>
        </td>
    </tr>
