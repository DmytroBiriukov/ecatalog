...
<?	  $dir_path="http://ecatalog.univ.kiev.ua/virt/";
	  ...
	  {
?>
		<a href="<? echo $dir_path; ?>series/v_<? echo $IDvolume; ?>.pdf" target="_blank"><img src="http://ecatalog.univ.kiev.ua/css/img/pdf_button.png"  width="15" height="15" border="0" title="файл з повнотекстовим змістом"/></a> 
<?
